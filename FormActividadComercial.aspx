<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="FormActividadComercial.aspx.cs" Inherits="Connecting.Web.FormActividadComercial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-envolver-pagina">
        <div class="form-titulo-principal"><span>Actividad Comercial</span></div>

        <dx:ASPxGridView ID="grid" runat="server" KeyFieldName="IdActividadComercial" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Nombre de Actividad Comercial " FieldName="ActividadComercial" VisibleIndex="0">
            ...
            <SettingsText Title="Actividad Comercial" />
            <SettingsPopup>
